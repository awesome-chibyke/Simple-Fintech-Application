  ...
  return `<!DOCTYPE html>
                      ...
                      "
                        ...
                        "
                            ...
                            "
                                ...
                                background-color:#ddd;
                                padding-top: 10px;
                                padding-bottom: 10px; border-bottom: 2px solid #1B1717; background: url(${
                                  $settingsObj.site_url +
                                  "/email_files/background-landscape.png"
    ...
    <!--           background-landscape.png                                 //ios_url,android_url-->
                                                <h2 style="text-align: left; text-transform: uppercase; font-family: '.$this->overPass.'; margin-bottom: 5px; padding-left: 10px; ">
                                                    <span style="color:rgb(10, 4, 60);">${
                                                      $settingsObj.site_name
                                                    }</span>
                                                </h2>
                              ...
                              "
                                            >
                                             ...
                                             } was successful. Below is a brief summary of the transaction.
                                            </p>
                                            <table
                                                    border="0"
                                                    cellpadding="0"
                                      ...
                                      "
                                            ...
                                            "
                                                                ...
                                                                <p><strong>Transaction Details: </strong></p> 
                                                                   <p><strong>Account Name: </strong> <span>${
                                                                     BankAccountDetails.account_name
                                                                   }</span></p> 
                                                                   ...
                                                                   <p><strong>Amount Transfered: </strong> <span>NGN ${
                                                                     BankAccountDetails.amount
                                                                   }</span></p>
                                                                   <p><strong>Balance: </strong> <span>NGN ${
...
module.exports = TransferMailTemplate;
