...
var CreditMailTemplate = require("../Emails/FintechEmailTemplate/CreditMailTemplate");
...
class SendDepositMails {
  ...
  async sendMail(userObject, BankAccountDetails, count = 0) {
    ...
    const emailTitle = "Credit Transaction Notification";
    ...
    let emailTemplate = CreditMailTemplate(
      fullName,
      emailTitle,
      systemSettings,
      BankAccountDetails
...
module.exports = SendDepositMails;
