const LoginAuthTemplate = (fullName, subject, $settingsObj, token) => {
                      ...
                      >
                        <div
                          style="
                            ...
                            background: url('background-landscape.png');
                        ...
                        >
                          ...
                          <h2
                            style="
                              ...
                              text-transform: uppercase;
                              padding-left: 10px;
                              font-family: '.$this->cursive.';
                              margin-top: 5px;
                            "
                          >
                            ${
                              $settingsObj.slogan === null
                                ? ""
                                : $settingsObj.slogan
                            }
                          </h2>
                        ...
                        <p
                          ...
                          "
                        >
                          Please provie the code below to login
                        </p>
                        <table
                          border="0"
                          cellpadding="0"
